...
public class AuthService
{
    ...
    public async Task LogoutAsync()
    {
        ...
        await _localStorage.RemoveAsync("selected_chat_id"); // Очистка выбранного чата
        _httpClient.DefaultRequestHeaders.Authorization = null;
        OnAuthChanged?.Invoke();
    }

    /// <summary>
    /// Сохранить выбранный чат в LocalStorage для восстановления после перезагрузки.
    /// </summary>
    ...
    /// <summary>
    /// Получить сохранённый ID выбранного чата из LocalStorage.
    /// </summary>
    ...
    /// <summary>
    /// Установить токен и UserId вручную (для восстановления сессии).
    /// </summary>
